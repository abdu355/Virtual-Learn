...
public class SpaceBtn : MonoBehaviour, IGvrGazeResponder
{
	...
	public GameObject effect,spaceaudio;
	...
	IEnumerator startTransfer()
	{
		...
		spaceaudio.SetActive (true);
		player.transform.position = new Vector3 (-86.62f, 7.2f, -3666f);
